				...
				<div class="ibox float-e-margins">
					...
					<div class="ibox-content">
						<form role="form" id="form_sm" >
							...
							<div class="form-group col-md-6" id="div_cantidad">
								
								
								<input type="hidden" class="form-control" id="cantidad" name="cantidad" value = "0" required>
							</div>
							
							<div class="form-group col-md-12" id="div_detalle">
								<label>Detalle:  </label>
								<textarea rows="4" class="form-control" cols="50" id="detalle" name="detalle" required></textarea>
							</div>
...
<script>
        $( document ).ready(function() {
			...
			$('#guardar_oper').click(function(){
				...
				Parametros="consulta=1&solicitud="+id_solici[0]+"&tipo_benef="+tipo_benef+"&categoria="+categoria+"&operador="+operador+"&cantidad="+cantidad+"&detalle="+detalle;
				...
				else
				{
					...
					$.ajax(
					{
						type: "POST",
						dataType:"html",
						url: "Sistema/Avituallamiento/ScriptGuardar.php",			
						data: Parametros,	
						beforeSend: function() 
						{
...
function cargar_combo_tipo_benef()
{
		...
		$.ajax(
		{
			type: "POST",
			dataType:"html",
			url: "Sistema/Avituallamiento/ScriptConsultar.php",			
			data: Parametros,	
			beforeSend: function() 
			{
				window.parent.parent.Cargando(1);
...
{	
	...
	$("#div_tabla").load('Sistema/Avituallamiento/FormTabla.php?id_sm='+id_solicitud);
