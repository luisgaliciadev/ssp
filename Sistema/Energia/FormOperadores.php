			...
			<div class="col-lg-12">
				<div class="ibox float-e-margins">
					<div class="ibox-title">
						<h5>Suministro de Energ&iacute;a</h5>
					</div>
			...
			$('#guardar_oper').click(function(){
				...
				else
				{
					...
					$.ajax(
					{
						...
						dataType:"html",
						async:false,
						url: "Sistema/Energia/ScriptGuardar.php",			
						data: Parametros,	
						beforeSend: function() 
						{
...
function cargar_combo_tipo_benef()
{
		...
		$.ajax(
		{
			type: "POST",
			dataType:"html",
			url: "Sistema/Energia/ScriptConsultar.php",			
			data: Parametros,	
			beforeSend: function() 
			{
				window.parent.parent.Cargando(1);
...
{	
	...
	$("#div_tabla").load('Sistema/Energia/FormTabla.php?id_sm='+id_solicitud);
