...
FROM            VIEW_EMPLEADO_CATEGORIA WHERE ID_SOL_SM=$ID_SOL_SM AND ID_TP_EMP_SM = 3";
              ...
              <tr>
                ...
                <!--<th width="20" title="Estatus">Estatus</th>-->
                   <th class="text-center" colspan="3">
					<button type="button" class="btn btn-success btn-xs" onClick="vModal('Sistema/Provisionales/FormNuevo.php?ID_SOL_SM=<?php echo $ID_SOL_SM;?>', 'Nuevo Empleado');" data-placement="top" data-toggle="tooltip" data-original-title="Nuevo Empleado" style=" cursor: pointer;">
