			...
			<div class="col-lg-12">
				<div class="ibox float-e-margins">
					<div class="ibox-title">
						<h5>Suministro de  Combustible</h5>
					</div>
					<div class="ibox-content">
						<form role="form" id="form_sm" >
							...
							<div class="form-group col-md-6" id="div_cantidad">
								...
								<input type="text" class="form-control number" id="cantidad" name="cantidad" required maxlength="10">
							</div>
			...
			$('#guardar_oper').click(function(){
				...
				else
				{
					...
					$.ajax(
					{
						type: "POST",
						dataType:"html",
						url: "Sistema/Combustible/ScriptGuardar.php",			
						data: Parametros,	
						beforeSend: function() 
						{
...
function cargar_combo_tipo_benef()
{
		...
		$.ajax(
		{
			type: "POST",
			dataType:"html",
			url: "Sistema/Combustible/ScriptConsultar.php",			
			data: Parametros,	
			beforeSend: function() 
			{
				window.parent.parent.Cargando(1);
...
{	
	...
	$("#div_tabla").load('Sistema/Combustible/FormTabla.php?id_sm='+id_solicitud);
