				...
				<div class="form-group col-md-12" >
					...
					<table class="table table-bordered">
						...
						<tbody>
							...
							<?php
								$vSQL="exec web.sp_listado_servicios_venta 2,$num_sol";
								...
								{		
									...
									{			
										...
										$BEN_RIF_CED =odbc_result($result,'BEN_RIF_CED');
										...
										$ID_STIPO_SERVICIO =odbc_result($result,'ID_STIPO_SERVICIO');
										
										$AGENTE =utf8_encode(odbc_result($result,'AGENTE'));
