...
$( document ).ready(function() {
	...
	$("#num_sm" ).change(function() {
		...
		if (num_sm.length == 0){
			...
			$("#consulta").load('Sistema/Ventas/Aprobar/FormTabla.php?num_sm='+num_sm);
			$(".boton").show();
		}
	...
	$("#gen_pre" ).click(function() {
        ...
        $.ajax(
        {
            type: "POST",
            dataType:"html",
            url: "Sistema/Ventas/Aprobar/ScriptInsertar.php",			
            data: Parametros,	
            beforeSend: function() 
            {
                window.parent.parent.Cargando(1);
        ...
        ?>
                    ...
                    else
                    {
                        ...
                        else
                        {
							...
							$(".boton").hide();									
                            AbrirModulo("MenDes2041", "Aprobar Solicitud", "Sistema/ventas/Aprobar/filtro.php");
