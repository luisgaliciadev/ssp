			...
			<div class="col-lg-12">
				<div class="ibox float-e-margins">
					<div class="ibox-title">
						<h5>Aprobar Planificaci&oacute;n de Solicitud</h5>
					</div>
					...
					<form role="form" id="form_sm" >
						...
						<div class="form-group col-md-12" >
							...
							<select class="form-control" id="num_sm"  required>
								...
								<?php 
									$vSQL="exec [web].[SP_LISTADO_SM_APROB_ADMIN]";
						...
						<div class="row">
							...
							<div class="form-group col-md-12 boton" >
								<button type="BUTTON" class="btn btn-primary" id="gen_pre">Aprobar Planificaci&oacute;n</button>			
							</div>	
						</div>	
					</form>
					</div>
...
$( document ).ready(function() {
	...
	$("#num_sm" ).change(function() {
		...
		if (num_sm.length == 0){
			...
			$("#consulta").load('Sistema/Ventas/Aprobar_pla/FormTabla.php?num_sm='+num_sm);
			$(".boton").show();
		}
	...
	$("#gen_pre" ).click(function() {
        ...
        $.ajax(
        {
            type: "POST",
            dataType:"html",
            url: "Sistema/Ventas/Aprobar_pla/ScriptInsertar.php",			
            data: Parametros,	
            beforeSend: function() 
            {
                window.parent.parent.Cargando(1);
        ...
        ?>
                    ...
                    else
                    {
                        ...
                        else
                        {
							...
							$(".boton").hide();									
                            AbrirModulo("MenDes2041", "Aprobar Solicitud", "Sistema/ventas/Aprobar_pla/filtro.php");
