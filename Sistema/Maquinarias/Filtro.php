			...
			<div class="col-lg-12">
				<div class="ibox float-e-margins">
					<div class="ibox-title">
						<h5> Solicitud de Maquinarias</h5>
					</div>
                   ...
                   <select name="ID_SOL_SM" id="ID_SOL_SM" style="width:95%" onChange="FiltroConsulta(1)" class="form-control">
                ...
                <table width="776" border="0" align="center">
                    <tbody>
                        <tr>
                          ...
                          <!--  <td width="202" align="right" style="color:#000; font-weight:bold;">Tripulante activo:</td>
                            <td width="19">
                              <div style="border:#000000 2px solid; border-radius:50%; width:15px; height:15px; background:#398439; margin:auto;"></div>
                          </td>

                            <td width="105" align="right" style="color:#000; font-weight:bold;">Tripulante inactivo:</td>
                            <td width="24">
		...
		<script>	
			...
			{			
				...
				if(ID_SOL_SM.trim())
				{
					...
					$.ajax(
					{
						type: "POST",
						dataType:"html",
						url: "Sistema/Maquinarias/FiltroConsulta.PHP",			
						data: Parametros,
						async:false,	
						beforeSend: function() 
						{
			...
			function Anularempleado(ID)
			{
					...
					$.ajax(
					{
						type: "POST",
						dataType:"html",
						url: "Sistema/Maquinarias/ScriptConsultar.PHP",			
						data: Parametros,
						async:false,	
						beforeSend: function() 
						{
