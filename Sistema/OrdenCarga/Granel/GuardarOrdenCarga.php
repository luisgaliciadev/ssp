<?php
	...
	$ID_SILO=$_POST['ID_SILO'];
	$ID_MUELLE=$_POST['ID_MUELLE'];
	...
	$vSQL="EXEC web.BP_GENERAR_ORDEN_PESAJE $ID_BL, $ID_PRODUCTO, '$USUARIO_CRE', '$CEDULA_COND', '$PLACA_VEHICULO', '$PLACA_REMOLQUE', $ID_SILO, $ID_MUELLE, '$DESTINO', '$COD_CONTE', $COD_ALMA, '$USUARIO_CRE_WEB'";
