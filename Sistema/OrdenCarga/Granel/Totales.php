<?php
	...
	$vSQL="exec [web].[SP_WEB_TOTALES_ORDEN_CARGA] $ID_BL, $USUARIO_CRE";
	...
	if($CONEXION=="SI" and $ERROR=="NO")
	{
		...
		$CANT_MANIFESTADA=odbc_result($resultPrin,"CANT_MANIFESTADA");
		$CANTIDAD_PESADA=odbc_result($resultPrin,"CANTIDAD_PESADA");
		$ROB=odbc_result($resultPrin,"ROB");
		$OCD=ceil(odbc_result($resultPrin,"OCD"));
		...
		$Arreglo["CANT_MANIFESTADA"]=$CANT_MANIFESTADA." Kgs.";
		$Arreglo["CANTIDAD_PESADA"]=$CANTIDAD_PESADA." Kgs.";
		$Arreglo["ROB"]=$ROB." Kgs.";
		$Arreglo["OCD"]=$OCD;
