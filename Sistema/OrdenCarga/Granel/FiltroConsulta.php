<?php
	...
	$vSQL="EXEC web.SP_VIEW_CONSULTA_ORDEN_CARGA '$RIF', $ID_BL, '$txtBuscar', $PagActual, $NroReg, '$Orden', '$AscDesc';";
              ...
              <tr>
                ...
                <!--<th width="20" title="Estatus">Estatus</th>-->
                   <th class="text-center" colspan="3">
					<button type="button" class="btn btn-success btn-xs" onClick="vModal('Sistema/OrdenCarga/Granel/FormNuevo.php?ID_BL=<?php echo $ID_BL;?>', 'Nueva Orden de Carga');" data-placement="top" data-toggle="tooltip" data-original-title="Nueva Orden de Carga" style=" cursor: pointer;">
				...
				{					
					...
					{						
						if($FG_NOTIFICACION==1)
						{
							...
							$Notificacion='
								<button type="button" class="btn btn-warning btn-xs" onClick="vModal2(\'Sistema/Notificaciones/VerNotificacion.php?ID_ORDEN_PESAJE='.$ID_ORDEN_PESAJE.'\', \'Ver Notificacion\');" data-placement="top" data-toggle="tooltip" data-original-title="Ver Orden de Carga" style=" cursor: pointer;">
									<i class="fa fa-bell"></i>
								</button>';	
