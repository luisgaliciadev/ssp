<?php
	...
	$vSQL="EXEC web.SP_VIEW_CONSULTA_ORDEN_CARGA_CARG_SUEL '$RIF', $ID_BL, '$txtBuscar', $PagActual, $NroReg, '$Orden', '$AscDesc';";
              ...
              <tr>
                ...
                <!--<th width="20" title="Estatus">Estatus</th>-->
                   <th class="text-center" colspan="3">
					<button type="button" class="btn btn-success btn-xs" onClick="vModal('Sistema/OrdenCarga/CargaSuelta/FormNuevo.php?ID_BL=<?php echo $ID_BL;?>', 'Nueva Orden de Carga');" data-placement="top" data-toggle="tooltip" data-original-title="Nueva Orden de Carga" style=" cursor: pointer;">
