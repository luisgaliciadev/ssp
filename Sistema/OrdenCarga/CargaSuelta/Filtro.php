...
<?php
                    $vSQL="EXEC web.SP_VIEW_WEB_USUARIO_BL '$RIF', 2;";
					//$vSQL="SELECT * FROM web.VIEW_WEB_USUARIO_BL WHERE RIF='$RIF' AND TIPO_CARGA=2;";
		...
		<script>		
			...
			{			
				...
				if(ID_BL.trim())
				{
					...
					$.ajax(
					{
						type: "POST",
						dataType:"html",
						url: "Sistema/OrdenCarga/CargaSuelta/FiltroConsulta.PHP",			
						data: Parametros,
						async:false,	
						beforeSend: function() 
						{
			...
			{								
				if(confirm("¿Desea Anular la Orden de Carga?"))
				{
					...
					$.ajax(
					{
						type: "POST",
						dataType:"html",
						url: "Sistema/OrdenCarga/CargaSuelta/AnularOrdenCarga.PHP",			
						data: Parametros,	
						beforeSend: function() 
						{
							window.parent.parent.Cargando(1);
			...
			function Totales()
			{
				...
				$.ajax(
				{
					type: "POST",
					dataType:"html",
					url: "Sistema/OrdenCarga/CargaSuelta/Totales.PHP",			
					data: Parametros,	
					beforeSend: function() 
					{
