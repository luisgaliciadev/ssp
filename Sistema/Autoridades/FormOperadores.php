			...
			$('#guardar_oper').click(function(){
				...
				else
				{
					...
					$.ajax(
					{
						type: "POST",
						dataType:"html",
						url: "Sistema/Autoridades/ScriptGuardar.php",			
						data: Parametros,	
						beforeSend: function() 
						{
...
function cargar_combo_tipo_benef()
{
		...
		$.ajax(
		{
			type: "POST",
			dataType:"html",
			url: "Sistema/Autoridades/ScriptConsultar.php",			
			data: Parametros,	
			beforeSend: function() 
			{
				window.parent.parent.Cargando(1);
...
{	
	...
	$("#div_tabla").load('Sistema/Autoridades/FormTabla.php?id_sm='+id_solicitud);
