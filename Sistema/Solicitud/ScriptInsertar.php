...
$tpago = $_POST["tpago"];
	...
	$vSQL="EXEC web.SP_CREAR_SOLICITUD '$RIF', $buque, '$c_popa', '$c_proa', '$fecha_d', '$capitan', '$viaje', $muelle, $pto_proc, $pto_destino, '$fecha_h',$nivel,$armador,$linea,$tipo_solicitud,'$USUARIO_CRE_WEB',5,8,$tpago";
