			...
			<div class="col-lg-12">
				<div class="ibox float-e-margins">
					<div class="ibox-title">
						<h5>Reparaci&oacute;n de Contenedor Refrigerado</h5>
					</div>
					<div class="ibox-content">
						<form role="form" id="form_sm" >
							...
							<div class="form-group col-md-6" id="div_cantidad">
								...
								<input type="text" class="form-control " id="cantidad" name="cantidad" onkeypress="return NumCheck(event, this)" maxlength="5" required>
							</div>
			...
			$('#guardar_oper').click(function(){
				...
				else
				{
					...
					$.ajax(
					{
						type: "POST",
						dataType:"html",
						url: "Sistema/Reparacion/ScriptGuardar.php",			
						data: Parametros,	
						beforeSend: function() 
						{
...
function cargar_combo_tipo_benef()
{
		...
		$.ajax(
		{
			type: "POST",
			dataType:"html",
			url: "Sistema/Reparacion/ScriptConsultar.php",			
			data: Parametros,	
			beforeSend: function() 
			{
				window.parent.parent.Cargando(1);
...
{	
	...
	$("#div_tabla").load('Sistema/Reparacion/FormTabla.php?id_sm='+id_solicitud);
