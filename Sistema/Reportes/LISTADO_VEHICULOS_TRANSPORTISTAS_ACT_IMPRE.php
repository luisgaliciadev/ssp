...
$vSQL = "SELECT [RIF]
      ...
      ,[PUERTO_ACCESO]
      ,[ANO_REGISTRO]
  FROM [dbo].[VIEW_RPT_VEHICULOS_TRANSPORTISTAS_ACT_IMP]
...
<table width="1300" border="0" align="center" class="tabla" >
  ...
  <tr>
    <td align="center" valign="middle">
      ...
      <h1>LISTADO DE VEH&Iacute;CULOS CON PASES IMPRESOS </h1>
...
<tr>
   ...
   <td width="50" >
    ...
    <td width="100" >
    	<div align="center">
        	<label style="text-align:center"  class="Estilo1">PLACA</label>
        </div>
    </td>
      <td width="100" >
    	<div align="center">
        	<label style="text-align:center"  class="Estilo1">TIPO VEH </label>
        </div>
    </td>
    <td width="100" >
    	<div align="center">
        	<label style="text-align:center"  class="Estilo1">MODELO </label>
        </div>
    </td>
    <td width="100" >
    	<div align="center">
        	<label style="text-align:center"  class="Estilo1">MARCA </label>
        </div>
    </td>
    <td width="100" >
    	<div align="center">
	...
	while (odbc_fetch_row($result))  
		...
		else
		{
			...
			$pintar=1;
				...
				<td><div align=\"center\">".odbc_result($result,"PLACA")."</div></td>
				<td><div align=\"center\">".odbc_result($result,"DS_TVEHICULO")."</div></td>
				<td><div align=\"center\">".odbc_result($result,"NB_MODELO_VEH")."</div></td>
				<td><div align=\"center\">".odbc_result($result,"NB_MARCA")."</div></td>
