...
<div style="width:800px; margin:auto;">
    	...
    	<br/>
<?php            
            $sql = "SELECT cast(f_preliq as date) as fecha_cre,RAZON_SOCIAL,rif,direcc_fiscal,id_preliquidacion, ESTATUS FROM VIEW_RP_CABECERA_REP_PRE WHERE ID_PRELIQUIDACION = $id_pre";
...
?>
            ...
            <tr>
             ...
             <tr>
            	<th align="left">ESTATUS </th> 
              	<td><div style="font-weight:200"><b><?php echo $ds_estatus;?></b></div></td>
            </tr>
        </table>
        <br/>
        <br/>
        <table border='1' style='border-collapse:collapse; margin:auto;'>
            <tr>
            	<th width="100" style="text-align:center" colspan='10'><b>DETALLE DE PRELIQUIDACION</b></th>
            </tr>
            <tr>
