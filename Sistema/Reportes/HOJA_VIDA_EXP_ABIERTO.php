...
";
	...
	while (odbc_fetch_row($rs2))  
	{
		...
		$F_PRELIQ			=	(odbc_result($rs2,"FECHA_PRELIQUIDACION"));	
...
<table width="800" border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#CCCCCC" class="fuenteP" style="width:1050px; margin:auto;" >
     ...
     $sql = "SELECT 
		...
		while (odbc_fetch_row($rs))
		{
			...
			$Enlace="<a href='javascript:' onclick='parent.AbrirVentana(\"ActaDeDocumentos\", \"Acta de Documentos\", \"Sistema/Reportes/ACTA_DOCUMENTO.php\", \"id_empr_acta=$ID_EMPR_ACTA&id_empresa=$id_empresa\", 600, 1000, 0, 1, 1, 1, 1);'>$ID_PRELIQUIDACION</a>";	
...
?>
    <tr <?php echo $clase;?>>
      <td ><a href="<?php echo $HREF;?>" target="_blank"><?php echo $COD_CONTRATO;?></a></td>
