...
if($consulta ==1)
{
	...
	$operador 	= $_POST["operador"];	
	 ...
	 $vSQL="EXEC web.[SP_INSERT_BENEF_SM] $solicitud,$tipo_benef,$categoria,'".$operador."'";
...
if($consulta ==2)
{
	...
	$vSQL="EXEC web.[SP_ANULA_BENEFICIARIO_SM] $Id_SM,'".$Rif_gen."','".$Rif_oper."',$Ano,$Id_solicitud";
