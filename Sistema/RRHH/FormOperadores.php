			...
			<div class="col-lg-12">
				<div class="ibox float-e-margins">
					<div class="ibox-title">
						<h5>Proveedor de Recursos Humanos</h5>
					</div>
			...
			$('#guardar_oper').click(function(){
				...
				else
				{
					...
					$.ajax(
					{
						type: "POST",
						dataType:"html",
						url: "Sistema/RRHH/ScriptGuardar.php",			
						data: Parametros,	
						beforeSend: function() 
						{
...
function cargar_combo_tipo_benef()
{
		...
		$.ajax(
		{
			type: "POST",
			dataType:"html",
			url: "Sistema/RRHH/ScriptConsultar.php",			
			data: Parametros,	
			beforeSend: function() 
			{
				window.parent.parent.Cargando(1);
...
{	
	...
	$("#div_tabla").load('Sistema/RRHH/FormTabla.php?id_sm='+id_solicitud);
