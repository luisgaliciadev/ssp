            ...
            <table cellpadding="0" cellspacing="0" width="600" class="w320">
              <tr>
                <td align="left" class="mobile-padding" style="padding:20px">
                  ...
                  <p><br>
                    Usted a solicitado cambio de clave de su cuenta en nuestro portal web, para porceder a realizarlo pulse 
                    <a href="<?php echo $RAIZ;?>./?&Correo=<?php echo $Correo;?>&CambiarClave=<?php echo $Kye;?>" title="aqui" target="_blank">aqui</a>.</p>
                  <br>
            ...
            <table border="0" cellpadding="0" cellspacing="0" width="600" class="w320" style="height:100%;">
              <tr>
                <td valign="top" class="mobile-padding" style="padding:20px;"><table cellspacing="0" cellpadding="0" width="100%">
                  <tr>
                    <td style="padding-top:50px;">ZonaLot te permite concursar por gradiosos productos y mucho más.</td>
                  </tr>
                </table></td>
              </tr>
            </table>
