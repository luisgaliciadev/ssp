<?php		
	...
	if(OBTENER_IP_SERVIDOR()==$_SESSION[$_SESSION['SISTEMA_SIGLA'].'SISTEMA_IP_PRODUCCION'])
		$RAIZ="http://www.zonalotto.com/";
	else
		$RAIZ="http://localhost/zonalot/";
?>
            ...
            <table cellpadding="0" cellspacing="0" width="600" class="w320">
              <tr>
                <td align="left" class="mobile-padding" style="padding:20px">
                  ...
                  <h2>Último paso, confirma tu cuenta de ZonaLot!</h2>
                  <p><br>
                    Hola <?php echo $Nombre;?>,<br><br>
                    Confirma tu dirección de correo electrónico para completar tu cuenta en ZonaLot. Es fácil, solo haz clic <a href="<?php echo $RAIZ;?>./?Key=<?php echo $Kye;?>" target="_blank">aqui</a>
                    <br>                    
                    <br>
            ...
            <table border="0" cellpadding="0" cellspacing="0" width="600" class="w320" style="height:100%;">
              <tr>
                <td valign="top" class="mobile-padding" style="padding:20px;"><table cellspacing="0" cellpadding="0" width="100%">
                  <tr>
                      <td style="padding-top:50px;">ZonaLot   te permite concursar por gradiosos premios. Cuando te unas, podrás participar en todos nuestros eventos y mucho más.</td>
                    </tr>
                </table>
                </td>
              </tr>
