				...
				<div class="form-group col-md-12" >
					...
					<table class="table table-bordered">
						...
						<tbody>
							...
							<?php
								$vSQL="exec web.SP_LISTADO_SERVICIOS_ADMIN 1,$num_sol";
	...
	function generar_preliq(id_solic, nb_procedure, conector, formato, stipos, agente, rif)
		{
			...
			$.ajax(
			{
				type: "POST",
				dataType:"html",
				url: "Sistema/Admin/Pendientes/Generales/ScriptGenPre.php",			
				data: Parametros,	
				beforeSend: function() 
				{
	...
	?>
						...
						{						
							...
							if($id>0)
							{
								...
								$("#consulta").load('Sistema/Admin/Pendientes/Generales/Tabla.php?id='+id_solic);
							}
							else
							{
								window.parent.Cargando(0);
